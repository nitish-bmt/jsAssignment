    ...
    urls.forEach((url) => {
      try{
        fetch(url)
          ...
          .catch(err=>console.log('one api failed'));
      }
      catch(error){'https://64c3af5b620f470f9014abc97971528a.api.mockbin.io/', 
...
const urls = ['https://www.fakeapi.co.uk/', 'https://api.open-meteo.com/v1/forecast?latitude=22.5411&longitude=88.3378&daily=weather_code,temperature_2m_max,temperature_2m_min&forecast_days=1', 'https://64c3af5b620f470f9014abc97971528a.api.mockbin.io/'
];
